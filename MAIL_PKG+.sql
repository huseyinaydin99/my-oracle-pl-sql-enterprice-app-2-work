...
Procedure Binary_Eklenti(P_Conn In Out Utl_Smtp.Connection,   P_File_Name In Varchar2,   P_Mime_Type In Varchar2, P_Oracle_Directory In Varchar2);
End Mail_Pkg;
/
create or replace 
...
PROCEDURE binary_eklenti(p_conn IN OUT UTL_SMTP.CONNECTION, p_file_name IN VARCHAR2, p_mime_type in VARCHAR2, p_oracle_directory IN VARCHAR2) IS
C_Max_Line_Width Constant Pls_Integer Default 54;
wv_amt            BINARY_INTEGER := 672 * 3; /*Format Deðeri; 2016 */
wv_bfile          BFILE;
